...
这是一个完全独立的工具包，包含以下工具：
- [4o_vehicle.py](file:///Users/zhaoshuaibo/Code/vehicle_control_tools/tools/4o_vehicle.py) - 4O链路车辆控制功能测试工具
- [im_vehicle.py](file:///Users/zhaoshuaibo/Code/vehicle_control_tools/tools/im_vehicle.py) - IM链路车辆控制功能测试工具
...
├── tools/                 # 工具脚本
│   ├── 4o_vehicle.py         # 4O链路车辆控制功能测试工具
│   └── im_vehicle.py              # IM链路车辆控制功能测试工具
├── fastfeishu/            # 飞书API集成库
│   ├── __init__.py
│   ├── configs/
│   │   ├── __init__.py
